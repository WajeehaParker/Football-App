  ...
  state={
    ...
    formdata:{
      email:{
        element:'input',
        value:'',
        config:{name:'email_input', type:'email', placeholder:'Enter your email'},
          ...
          <form onSubmit={(event)=>this.submitForm(event)}>
            ...
            <div className="enroll_input">
              ...
              <div className="enroll_discl">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a velit sit amet ligula hendrerit blandit a id ex. Etiam ac ullamcorper dolor.
              </div>
            </div>
          </form>
        </div>
